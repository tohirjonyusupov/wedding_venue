                        ...
                        <div className="flex items-center text-sm gap-1.5 text-gray-500">
                          <div className="mb-4">
                            ...
                            <select
                              id="owner_id"
                              name="owner_id"
                              value={venueOwners[venue.id] || ""}
                              onChange={(e) => handleAssignOwner(e, venue.id)}
                          ...
                          <button
                            className={`inline-flex rounded-full px-3.5 py-1 cursor-pointer text-xs font-medium bg-amber-200 text-gray-800 hover:bg-amber-300 disabled:opacity-50`}
                            onClick={() => handleConfirim(venue.id)}
                            disabled={venue.status === "tasdiqlangan"}
                            title="Confirm"
                          >
                            Tasdiqlash
                          </button>
                  ...
                  <div className="sm:flex">
                    ...
                    <div className="flex flex-1 flex-col justify-between p-6">
                      ...
                      <div className="mt-4 flex items-center justify-end space-x-2">
                        ...
                        <button
                          className={`inline-flex rounded-md px-3 py-3 cursor-pointer text-xs font-medium bg-amber-200 text-gray-800 hover:bg-amber-300 disabled:opacity-50`}
                          onClick={() => handleConfirim(venue.id)}
                          disabled={venue.status === "tasdiqlangan"}
                          title="Confirm"
                        >
