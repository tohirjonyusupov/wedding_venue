...
export default function BookingsList() {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      const response = await axios.get(
        `https://wedding-venue.onrender.com/owner/bookings/${id}`
      );
  ...
  const uniqueDistricts = [
    ...new Set(bookings.map((booking) => booking.district_name)),
  ];
  ...
  useEffect(() => {
    ...
    if (districtFilter) {
      result = result.filter(
        (booking) => booking.district_name === districtFilter
      );
    }
  ...
  const handleCancelBooking = async (bookingId) => {
    try {
      const response = await axios.patch(
        `https://wedding-venue.onrender.com/owner/bookings/${bookingId}/cancel/`
      );
